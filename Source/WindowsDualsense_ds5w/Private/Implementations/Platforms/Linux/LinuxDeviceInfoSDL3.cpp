...
void FLinuxDeviceInfoSDL3::Read(FDeviceContext* Context)
{
...
void FLinuxDeviceInfoSDL3::ProcessAudioHaptic(FDeviceContext* Context)
{
	if (!Context || !Context->Handle)
	{
		return;
...
void FLinuxDeviceInfoSDL3::ConfigureFeatures(FDeviceContext* Context)
{
	SDL_hid_device* DeviceHandle = static_cast<SDL_hid_device*>(Context->Handle);
...
void FLinuxDeviceInfoSDL3::Write(FDeviceContext* Context)
{
	if (!Context || !Context->Handle)
	{
		return;
...
void FLinuxDeviceInfoSDL3::Detect(std::vector<FDeviceContext>& Devices)
{
	Devices.clear();
...
bool FLinuxDeviceInfoSDL3::CreateHandle(FDeviceContext* Context)
{
	if (!Context)
	{
		return false;
...
void FLinuxDeviceInfoSDL3::InvalidateHandle(FDeviceContext* Context)
{
	if (Context)
	{
		SDL_hid_device* DeviceHandle = static_cast<SDL_hid_device*>(Context->Handle);
...
void FLinuxDeviceInfoSDL3::InitializeAudioDevice(FDeviceContext* Context)
{
	if (!Context)
	{
		return;
